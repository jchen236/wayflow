...
for i in range(len(your_list)):
    ...
    sentence = models.doc2vec.LabeledSentence(words=words, tags = ["SENT_" + str(your_list[i][0])])
    sentences.append(sentence)

model = models.Doc2Vec(size = 300, window = 20, alpha=.025, min_alpha=.025, min_count=2, workers =10)
